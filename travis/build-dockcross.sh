...
docker run --rm -v `realpath ..`:/io alphacep/kaldi-dockcross-x86 /io/travis/build-wheels-dockcross.sh
docker run --rm -v `realpath ..`:/io alphacep/kaldi-dockcross-riscv /io/travis/build-wheels-dockcross.sh
