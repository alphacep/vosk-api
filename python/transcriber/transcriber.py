...
class Transcriber:
    ...
    def get_model(args):
        ...
        def get_model_name_using_model_name_arg(args, models_path):
        ...
        def get_model_name_using_lang_arg(args, models_path):
        ...
        def download_model(model_location, models_path):
        ...
        if args.lang == None:
            result_model = get_model_name_using_model_name_arg(args, models_path)
        else:
            result_model = get_model_name_using_lang_arg(args, models_path)
        model_location = str(Path(models_path, result_model))
        model = download_model(model_location, models_path)
        return model
